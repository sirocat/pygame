...
# 캐릭터 만들기
character = pygame.image.load(os.path.join(image_path, "hoduman1.png"))
...
# 무기 만들기
weapon = pygame.image.load(os.path.join(image_path, "sword.png"))
...
ball_images = [
    pygame.image.load(os.path.join(image_path, "hodu1.png")),
    pygame.image.load(os.path.join(image_path, "hodu1.png")),
    pygame.image.load(os.path.join(image_path, "hodu2.png")),
    pygame.image.load(os.path.join(image_path, "hodu3.png"))]
